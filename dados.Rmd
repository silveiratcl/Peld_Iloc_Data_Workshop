...
*As tres regras para um conjunto de dados "tidy" [R for Data Science](https://r4ds.had.co.nz)*
...
Essa seria uma demonstração de criação e uma tabela larga oriunda de um banco de dados "tidy".   
...
Outra estratégia para evitar erros de digitação e tornar a informação de fácil compreenssão para pessoas é ter sempre disponível com os dados um arquivo ou uma aba **README**. Estes arquivos são informações que não fazem parte do banco de dados, mas ajudam na comprenssão do que é apresentado.  
...
Outro cuidado que pode ser tomado também é seguir uma lógica de nomeação de arquivos. Procurar ser o mais informativo possível ajuda a organizar os arquivos e o acesso a informação.  
