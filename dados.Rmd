...
O tipo de oraganização apresentada no primeiro exemplo é denominda por Wickham e Grolemund (2017) como "tidy data". Segundo os autores, esta organização de dados é regida por três regras:
...
<img src= "figs/data_9.png" style= "width:50%">
...
| Nome pouco infomartivo               | Sugestão                             |
|:------------------------------------:|:------------------------------------:|
| dados_reef_fish.xls                  | reef_fish_pels_ThiagoS_2021_07_27.xls|            
| dados_rocas_final.xls                | benthos_rocas_ThiagoS_2021_07_27.xls |                         
