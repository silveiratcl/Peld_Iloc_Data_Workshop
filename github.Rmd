...
Agora que já vimos como fazer as principais ações usando o **Git** e **Github**, agora podemos executar um grupo de comandos que consiste na grande vantagem de se usar o **Github**: a colaboração com controle de versão. Abaixo um resumo dos comandos abordados:
