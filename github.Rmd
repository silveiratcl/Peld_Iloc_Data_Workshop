...
Clique novamente no botão **Create pull request** para confirmar sua contribuição. Se você visitar agora a página [https://github.com/peld-iloc/repo_test](https://github.com/peld-iloc/repo_test)
...
Esse foi um exercício simples de colaboração usando Git e Github. Para mais informações dobre o workflow usando o Github acesse [Github Guides](https://guides.github.com/introduction/flow/)
